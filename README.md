...
Simplify your kitchen management with **Fridge Master**, a full-stack web application built with **backend** (Python, AWS Lambda), **frontend** (React, JavaScript), and **database** (PostgreSQL).  
